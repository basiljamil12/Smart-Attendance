  ...
  return (
    <div className="flex">
      ...
      <div className="w-full">
        <div className="m-8 md:flex md:items-start md:justify-start">
          <span className="text-sa-maroon font-bold text-2xl">
            Faculty Dashboard
          </span>
        </div>
        <div className="mt-14">
          <div className="flex justify-between mx-10 md:mx-24">
            ...
            <span
              className="text-sa-maroon font-bold text-md underline hover:cursor-pointer"
