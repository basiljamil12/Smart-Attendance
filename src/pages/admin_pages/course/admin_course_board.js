    ...
    <div className="flex">
      ...
      {showLoading ? (
        ...
        <div className="w-full">
          ...
          <div className="flex justify-between xl:mx-10 mx-10">

              <span className="text-sa-maroon md:ml-4 font-bold md:mt-0 mt-2 text-xl md:text-2xl">
                Course List
              </span>
              <Button
              ...
              {/* <button
                    //className="transition-opacity hover:opacity-85 text-sa-maroon font-bold text-lg pt-0.5  hover:cursor-pointer"
            ...
            <div className="mb-20 overflow-x-auto mt-10 mx-10 lg:ml-[6%] lg:w-[92%] lg:shadow-xl rounded-2xl">
