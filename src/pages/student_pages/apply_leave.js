    ...
    return (
        <div>
            ...
            <div className="md:ml-14 ml-5 mx-[6%] ">
                <p className="text-sa-maroon text-[36px] text-left md:mt-10 mt-6 font-bold">Apply Leave</p>
                <div className="md:ml-3 ml-2 mt-5 md:mt-6 mb-5 ">
                    ...
                    <input
                        ...
                        value={subject}
                        className={`placeholder-gray-500 w-full   border-[1px] border-black border-solid   text-black p-2 rounded-xl focus:outline-none focus:ring-0 focus:border focus:border-sa-maroon ${subject1
                            ? "border-red-500"
                    ...
                    <div className="w-full mb-5 md:ml-3  md:mr-[2%] md:mx-0 ">
                        ...
                        <div className="flex">
                            <input
                                ...
                                id="startDate"
                                className={`w-full hover:cursor-pointer text-filter-heading bg-clue-black p-2 rounded-[10px] border-[1px] border-black border-solid focus:outline-none focus:ring-0 focus:border focus:border-sa-maroon ${startDate1Empty
                                    ? "border-red-500"
                                    : "border-[1px] border-black border-solid"
                                    }`}
                            />
                    ...
                    <div className="w-full mb-3 md:ml-0  ">
                        ...
                        <div className="flex">
                            <input
                                ...
                                id="endDate"
                                className={`w-full hover:cursor-pointer text-filter-heading bg-clue-black p-2 rounded-[10px] border-[1px] border-black border-solid focus:outline-none focus:ring-0 focus:border focus:border-sa-maroon ${endDate1Empty
                                    ? "border-red-500"
                                    : "border-[1px] border-black border-solid "
                                    }`}
                            />
    ...
    />
                ...
                <div className="md:ml-3 ml-2 md:mb-6 mb-10 ">
                    ...
                    <textarea
                        ...
                        value={reason}
                        className={`placeholder-gray-500 w-full md:h-52 h-40 resize-none border-[1px] border-black border-solid text-black bg-clue-black p-2 rounded-xl focus:outline-none focus:ring-0 focus:border focus:focus:border-sa-maroon ${reason1
                            ? "border-red-500"
                            : "border-[1px] border-black border-solid "
                            }`}
                    />
